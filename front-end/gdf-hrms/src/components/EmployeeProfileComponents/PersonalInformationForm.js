  ...
  function FormRow() {
    return (
      <React.Fragment>
        ...
        <div>
          <Grid item xs={2}>
            <TextField id="dateOfBirth" label="Date of Birth" variant="outlined" InputLabelProps={{ shrink: true,}} size="small" type="text" defaultValue={employeeInfo.employeeInfo.dateOfBirth}/>            
